          ...
          >
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <p className="text-sm text-gray-500 mt-4">
                Registration closes on <span className="font-semibold text-orange-600">15th October 2025</span>
              </p>
            </div>
          </motion.div>
        </SignedOut>
            ...
            >
              ...
              >
                ...
                <div className="mt-6 bg-orange-50 border border-orange-200 rounded-lg p-4">
                  <p className="text-orange-700 font-semibold">📅 Registration Deadline: 15th October 2025</p>
                </div>
              </motion.div>
